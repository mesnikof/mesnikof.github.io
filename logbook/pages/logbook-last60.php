 ...
 * 60 calendar days of data (an FAA legaility test is based upon no greater than 200 flight hours in
 * a rolling 60 day "lookback").
 *
 ...
 * of data and for the overall totals for the entire 60 days.
 *
 * Note: While outwardly similar, there are some subtle differences between this script ant the
 *       logbook-last30.php script, making it necessary to keep and maintain both for now.
 *
 ...
 *       system.
 *
 * TODO: Explore the possibility of combining the 30- and 90-day scripts into one for ease of maintenance.
 */
...
/*
 * Create and run the SQL query to get any data from the preceding 60 days.  Note: We are refereing to the dates
 * the flights occurred, not the dates the data was entered.
 *
 * For information on the MySQL connector methods, please consult the MySQL documentation.  Here we will simply
...
if($result->num_rows > 0) {
    while($row = $result->fetch_row()) {
        ...
        /*
         * The next item is one of the time elements requires a running total to be maintained.
         * We do the simple "+=" math to maintain this total.
         *
